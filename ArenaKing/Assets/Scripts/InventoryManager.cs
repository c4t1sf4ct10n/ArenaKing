...
public class InventoryManager : MonoBehaviour
{
    ...
    void DisplayEquipments()
    {
        ...
        attack.GetComponent<Text>().text = PlayerManager.instance.GetPlayerAttack().ToString();
        health.GetComponent<Text>().text = PlayerManager.instance.GetPlayerHealth().ToString();
